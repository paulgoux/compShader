...
void main(void) {
  ...
  float num = (xx+yy);
  float numf = abs(num - floor(num))*10000000 ;
  
  //float rni = (mod (numf/(base*base),base))/255-1.0/255.0;
  //float gni = (mod ((numf/base),base))/255-1.0/255.0;
  //float bni = (mod ((numf),base))/255;
