...
float tvb0 = (vib0.r*b1 + vib0.g*b2 + vib0.b*b3 )/1000000;
float tva1 = (via1.r*b1 + via1.g*b2 + via1.b*b3);
float tvb1 = (vib1.r*b1 + vib1.g*b2 + vib1.b*b3 )/1000000;
float num = (tvb0+tvb1)*1.0;
float numf = abs(num - floor(num))*1000000 ;
 numf = numf;
